...
<div class="px-6 py-4">
    ...
    <div class="bg-white rounded-xl shadow p-6 w-full md:w-2/3">
        <form method="POST" action="{{ route('warga.updateProfil') }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" value="{{ old('email', $user->email) }}" class="w-full px-4 py-2 border rounded" readonly>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="alamat" class="w-full px-4 py-2 border rounded">{{ old('alamat', $user->alamat) }}</textarea>
            </div>
            ...
            <div class="flex justify-between items-center mt-6">
                <a href="{{ route('warga.profil') }}" class="bg-gray-300 text-gray-800 px-4 py-2 rounded hover:bg-gray-400 transition">
                    ← Kembali ke Profil
                </a>
