<div class="bg-white shadow-sm border-b border-[#d46a6d]/20">
    <div class="px-8 py-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Halo, {{ Auth::guard('warga')->user()->nama }}! 👋</h1>
                <p class="text-gray-600">Selamat datang di <span class="font-semibold text-[#d46a6d]">LaporAja!</span></p>
            </div>
